...
Naming convention:
    docs/internal/captain/voice/{YYYY-MM-DD}/{HH-MM-SS}.wav          — raw audio
    docs/internal/captain/voice/{YYYY-MM-DD}/{HH-MM-SS}.transcript   — plain text transcript
    docs/internal/captain/voice/{YYYY-MM-DD}/digest.md               — collated daily digest
...
HULL_ROOT = (
    Path(__file__).resolve().parent.parent / "docs" / "internal" / "captain" / "voice"
)
